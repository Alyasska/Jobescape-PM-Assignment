...
| **C3** · What's next | Five phases: **instrument (hold-out) → fix the first 10 minutes → build the gate → quality → reach**. Reach is last because CSAT *falls* as engagement rises | 09 |
